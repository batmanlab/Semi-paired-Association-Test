...
out_path = '../outputs/copd_kl_geneExp';
...
dataset.loader = @dataset_copd_kl_geneExp;
...
% save data and plots
save(fullfile(out_path,[num2str(pars.ratio) '_real.mat']),'p_val0','p_val','p_valSemi','Sta','StaSemi','nlSel','nlSelUp');
savefig(h,fullfile(out_path,[num2str(pars.ratio) '_real.fig']));
