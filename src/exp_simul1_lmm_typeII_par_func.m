...
out_path = '../outputs/simul1_lmm_typeII/';
...
% output_subdir = sprintf('h2_%.2f_sig%.2f_signx%.2f_signy%.2f_dzx%d_dzy%d_dx%d_dy%d_N%d_LMM%d', ...
%     dataset.h2, dataset.sigma, dataset.sigma_nx, dataset.sigma_ny, dataset.xzdim, dataset.yzdim, dataset.xdim, dataset.ydim, dataset.N, dataset.LMM);
