...
out_path = '../outputs/copd_kl_biomarker';
...
dataset.loader = @dataset_copd_kl_biomarker;
...
% save data and plots
save(fullfile(out_path,[num2str(dataset.fev1) '_' num2str(pars.ratio) '_real.mat']),'p_val0','p_val','p_valSemi','Sta','StaSemi','nlSel','nlSelUp');
savefig(h,fullfile(out_path,[num2str(dataset.fev1) '_' num2str(pars.ratio) '_real.fig']));
